...
type BTC15MPreviousDayRangeReversionSourceRow struct {
...
type BTC15MPreviousDayRangeReversionCoverageRow struct {
	BacktestName         string `json:"backtest_name"`
	CandidateID          string `json:"candidate_id"`
...
type BTC15MPreviousDayRangeReversionSignalRow struct {
	...
	PriorDay                  string    `json:"prior_day"`
	PriorDayHigh              float64   `json:"prior_day_high"`
	PriorDayLow               float64   `json:"prior_day_low"`
	PriorDayMidpoint          float64   `json:"prior_day_midpoint"`
	PriorDayRangeWidth        float64   `json:"prior_day_range_width"`
	OuterZonePct              float64   `json:"outer_zone_pct"`
...
type BTC15MPreviousDayRangeReversionSkipRow struct {
	CandidateID       string `json:"candidate_id"`
	Split             string `json:"split"`
...
type BTC15MPreviousDayRangeReversionTradeRow struct {
	SignalID   string    `json:"signal_id"`
...
type BTC15MPreviousDayRangeReversionFalsification struct {
	BacktestName                      string   `json:"backtest_name"`
	CandidateID                       string   `json:"candidate_id"`

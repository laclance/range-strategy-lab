...
next path is a BTCUSDT higher-timeframe nested range-rotation audit brief after
the local BTC/ETH/SOL range-universe baselines failed promotion gates. Older
...
25. [docs/FUTURES_RANGE_CANDIDATE_DISCOVERY_SPEC.md](docs/FUTURES_RANGE_CANDIDATE_DISCOVERY_SPEC.md)
26. [docs/FUTURES_RANGE_CANDIDATE_DISCOVERY_REVIEW.md](docs/FUTURES_RANGE_CANDIDATE_DISCOVERY_REVIEW.md)
27. [docs/FUTURES_CLEAN_BREAKOUT_BASELINE_REVIEW.md](docs/FUTURES_CLEAN_BREAKOUT_BASELINE_REVIEW.md)
28. [docs/FUTURES_RANGE_UNIVERSE_DISCOVERY_SPEC.md](docs/FUTURES_RANGE_UNIVERSE_DISCOVERY_SPEC.md)
29. [docs/FUTURES_RANGE_UNIVERSE_DISCOVERY_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_DISCOVERY_REVIEW.md)
30. [docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_BASELINE_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_BASELINE_REVIEW.md)
31. [docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_OPTIMIZATION_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_OPTIMIZATION_REVIEW.md)
32. [docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_STRATEGY_SPEC.md](docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_STRATEGY_SPEC.md)
33. [docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_STRATEGY_REPLAY_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_STRATEGY_REPLAY_REVIEW.md)
34. [docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_WALK_FORWARD_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_STRUCTURED_COMPRESSION_WALK_FORWARD_REVIEW.md)
35. [docs/FUTURES_RANGE_UNIVERSE_POST_STRUCTURED_COMPRESSION_PIVOT_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_POST_STRUCTURED_COMPRESSION_PIVOT_REVIEW.md)
36. [docs/FUTURES_RANGE_UNIVERSE_BREAKOUT_RETEST_ACCEPTANCE_BASELINE_REVIEW.md](docs/FUTURES_RANGE_UNIVERSE_BREAKOUT_RETEST_ACCEPTANCE_BASELINE_REVIEW.md)
37. [memory/NEXT_CODEX_BRIEF.md](memory/NEXT_CODEX_BRIEF.md)
